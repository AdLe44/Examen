...
<html lang="es-MX">
    <head>
        ...
        <script src="../config/library/JQuery_3_6_3.js" ></script>
        <!-- Icons -->
    ...
    <body>
                    ...
                    <div class="container d-flex">
                        ...
                        <div class="input-group mb-3" id="contenedor_genero_acc">
                            ...
                            <button class="btn btn-outline-secondary"
                                    ...
                                    data-bs-target="#modal_add_genero"
                    ...
                    <div class="container d-flex">
                        <div class="input-group mb-3" id="contenedor_direccion_acc">
                            ...
                            <button class="btn btn-outline-secondary"
                                    type="button"
                                    data-bs-toggle="modal"
                                    data-bs-target="#modal_add_direccion"
        ...
        <?php include './view/modules/modal_add_direccion.php'; ?>
        <?php include './view/modules/modal_add_genero.php'; ?>
    </body>
</html>